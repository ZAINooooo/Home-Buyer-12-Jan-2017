...
public class RentCommercialFragment extends Fragment {
     ...
     * @return A new instance of fragment RentCommercialFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static RentCommercialFragment newInstance(String param1, String param2) {
        RentCommercialFragment fragment = new RentCommercialFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layout= inflater.inflate(R.layout.fragment_rent_commercial, container, false);
    ...
    private void searchbuttompressed(){
...

        {
            ...
            public void onClick(View view) {
                selectedtype();
                DatabaseReference mRef=mdatabase.child("Property").child("Rent").child("Commercial");
