 ...
 * Use the {@link BuyResidencialFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class BuyResidencialFragment extends Fragment {
     ...
     * @return A new instance of fragment BuyResidencialFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static BuyResidencialFragment newInstance(String param1, String param2) {
        BuyResidencialFragment fragment = new BuyResidencialFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        layout = inflater.inflate(R.layout.fragment_buy_residencial, container, false);
    ...
    private void searchbuttompressed(){
       ...
       // final String mCity= String.valueOf(citysearch.getText().toString());
        mSearchButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                selectedtype();
                selectedbedroom();
                DatabaseReference mRef=mdatabase.child("Property").child("Sell").child("Residential");
                    ...
                    public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                        ...
                        if (!typese.isEmpty()&&typese.contains(sq)) {
                            for (DataSnapshot child : dataSnapshot.getChildren()) {
                                System.out.println("We're done loading the initial "+child.getKey()+"asd"+dataSnapshot.getKey());
    ...
    private void typecasting(View viewfragment){
        citysearch=(AutoCompleteTextView) viewfragment.findViewById(R.id.Buycitysearch);
        mSearchButton=(Button) viewfragment.findViewById(R.id.OwnerButton);
        propertylayout=(LinearLayout) viewfragment.findViewById(R.id.mBuypropertytype);
        bedroomlayout=(LinearLayout)viewfragment.findViewById(R.id.buybedroomcount);
    }
    @Override
